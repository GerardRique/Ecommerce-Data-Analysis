...
def get_statistics(path, product_price_dict):
    mean_reviews = {}
    statistics_dict = {}
    ...
    return mean_reviews, statistics_dict, all_product_rating_hist, mean_review, user_num_reviews_dict, expensive_high_review_item, highest_price, cheap_high_review_item, cheapest_price, user_num_helpful_dict
...
def main():
    ...
    mean_reviews, statistics_dict, all_product_rating_hist, mean_review, user_num_reviews_dict, expensive_high_review_item, highest_price, cheap_high_review_item, cheapest_price, user_num_helpful_dict = get_statistics('../AmazonDataset/reviews_Musical_Instruments.json.gz', product_price_dict)
